...
const Hero = () => {
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("./src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
        ...
        <p className='max-w-130 mt-2 text-sm md:text-base'>unparalleled Luxuary and Comfort await at the world's most exculsive hotels and resorts. Start your journey today. </p>
