  ...
  return room &&(
    ...
    <div className='flex flex-col md:flex-row md:justify-between mt-10'>
        <div className='flex flex-col'>
            <h1 className='text-3xl md:text-4xl font-playfair'>Experience Luxuray Like Never Before</h1>
   ...
   <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>
            ...
            price quoted is for two guest, at the guest slot please mark the number of guests to get 
