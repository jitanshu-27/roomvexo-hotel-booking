  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24'>
        ...
        {roomsDummyData.map((room)=>(
            <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                <img onClick={()=>{navigate(`/rooms/${room._id}`); scrollTo(0,0)}}
                    src={room.images[0]} alt="hotel-image" title='View Rooms Details' className='max-h-65 md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer'/>
      ...
      <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 max-lg:mt-16'>
          <div className={`flex items-center justify-between px-5 py-2.5 lg:border-b border-b-gray-300 ${openFilters ? "border-b" : ""}`}>
              <p>FILTERS</p>
